...
public class UserLoginPageTest extends Base {

	@Test
	public void verifyValidUsercredential() {
		String usernameExcel = ExcelUtility.getStringData(7, 0, "LoginPage");
		String passwordExcel = ExcelUtility.getIntegerData(7, 1, "LoginPage");
